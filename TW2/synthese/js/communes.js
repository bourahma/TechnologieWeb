...
function initForm(){
  ...
  detail = document.getElementById("details1");
...
function sendLogout(ev){
    ...
    fetchFromJson(url).then(processAnswer);
}
...
function sendForm(ev){ // form event listener
    ...
    lis.textContent = 'Attendez, S\'il Vous Plaît..';
}
...
function fetchCommune(){
    ...
    detail.textContent = 'Attendez, S\'il Vous Plaît..';
}
